...
{
    /// <inheritdoc />
    public partial class AddEmissionParameters : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmissionParameters", x => x.ReactionId);
                    table.ForeignKey(
                        name: "FK_EmissionParameters_Reactions_ReactionId",
