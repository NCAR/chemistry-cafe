...
{
    public class UserMechanismController : Controller
    {
        private readonly ChemistryDbContext _context;

        public UserMechanismController(ChemistryDbContext context)
        {
            _context = context;
        }
