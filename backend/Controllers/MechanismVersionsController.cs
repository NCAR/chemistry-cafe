...
{
    public class MechanismVersionsController : Controller
    {
        private readonly ChemistryDbContext _context;

        public MechanismVersionsController(ChemistryDbContext context)
        {
            _context = context;
        }

        // GET: MechanismVersions
        ...
        // GET: MechanismVersions/Details/5
        ...
        // GET: MechanismVersions/Delete/5
        ...
        // POST: MechanismVersions/Delete/5
