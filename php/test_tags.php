...
switch('tstfilewrite')  { // testing :  php < thisfile.php
    ...
    case 'tstfilewrite' :
            ...
            $tagdir = '/home/mattdawson/testdir/'.$tagref['filename'];
            mkdir($tagdir);
...
function create_tag() {
    ...
    $normalized_name = preg_replace('/[^a-zA-Z0-9_.]/', '_', $branch_name);

    $target_file_name = "MZ".$tag_id."_".trim($normalized_name)."_".date("Ymd");
