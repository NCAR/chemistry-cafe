    ...
    get_reaction_by_id = function(chemistry){
        $http.post(
            "/php/chemistry.php?action=get_reaction_by_id",
            {
             ...
             chemistry.rate_constant_function_id = data.rate_constant_function_id;
             chemistry.rate_constant_call = data.rate_constant_call;
             chemistry.rate_constant_name = data.rate_constant_name;
             chemistry.fortran = data.fortran;
        }).error(function (data, status, headers, config) {
    ...
    $scope.populateEditForm = function(chemistry) {  
      $http.post('/php/chemistry.php?action=get_reaction_by_id', 
        ...
        .success(function (data, status, headers, config) {    
          ...
          $scope.sourceData.rate_function_present = ($scope.sourceData.rate_function_id >> 0);
          $scope.formData = data;
