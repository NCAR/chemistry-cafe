...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260911160825_AddArrheniusParameters') THEN

    CREATE TABLE `ArrheniusParameters` (
        `ReactionId` char(36) COLLATE ascii_general_ci NOT NULL,
        `A` double NULL,
        `B` double NULL,
        `C` double NULL,
        ...
        `D` double NULL,
        `E` double NULL,
        CONSTRAINT `PK_ArrheniusParameters` PRIMARY KEY (`ReactionId`),
        CONSTRAINT `FK_ArrheniusParameters_Reactions_ReactionId` FOREIGN KEY (`ReactionId`) REFERENCES `Reactions` (`Id`) ON DELETE CASCADE
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260911160825_AddArrheniusParameters', '8.0.10');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260916151848_AddTunnelingParameters') THEN

    CREATE TABLE `TunnelingParameters` (
        `ReactionId` char(36) COLLATE ascii_general_ci NOT NULL,
        `A` double NULL,
        `B` double NULL,
        `C` double NULL,
        CONSTRAINT `PK_TunnelingParameters` PRIMARY KEY (`ReactionId`),
        CONSTRAINT `FK_TunnelingParameters_Reactions_ReactionId` FOREIGN KEY (`ReactionId`) REFERENCES `Reactions` (`Id`) ON DELETE CASCADE
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260916151848_AddTunnelingParameters', '8.0.10');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260916165919_AddTernaryChemicalActivationParameters') THEN

    CREATE TABLE `TernaryChemicalActivationParameters` (
        `ReactionId` char(36) COLLATE ascii_general_ci NOT NULL,
        `K0A` double NULL,
        `K0B` double NULL,
        `K0C` double NULL,
        ...
        `Fc` double NULL,
        `N` double NULL,
        CONSTRAINT `PK_TernaryChemicalActivationParameters` PRIMARY KEY (`ReactionId`),
        CONSTRAINT `FK_TernaryChemicalActivationParameters_Reactions_ReactionId` FOREIGN KEY (`ReactionId`) REFERENCES `Reactions` (`Id`) ON DELETE CASCADE
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260916165919_AddTernaryChemicalActivationParameters', '8.0.10');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260918003206_AddTaylorSeriesParameters') THEN

    CREATE TABLE `TaylorSeriesParameters` (
        `ReactionId` char(36) COLLATE ascii_general_ci NOT NULL,
        `A` double NULL,
        `B` double NULL,
        `C` double NULL,
        ...
        `D` double NULL,
        `E` double NULL,
        `TaylorCoefficients` longtext CHARACTER SET utf8mb4 NULL,
        CONSTRAINT `PK_TaylorSeriesParameters` PRIMARY KEY (`ReactionId`),
        CONSTRAINT `FK_TaylorSeriesParameters_Reactions_ReactionId` FOREIGN KEY (`ReactionId`) REFERENCES `Reactions` (`Id`) ON DELETE CASCADE
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260918003206_AddTaylorSeriesParameters', '8.0.10');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260918160500_AddEmissionParameters') THEN

    CREATE TABLE `EmissionParameters` (
        `ReactionId` char(36) COLLATE ascii_general_ci NOT NULL,
        `ScalingFactor` double NULL,
        CONSTRAINT `PK_EmissionParameters` PRIMARY KEY (`ReactionId`),
        CONSTRAINT `FK_EmissionParameters_Reactions_ReactionId` FOREIGN KEY (`ReactionId`) REFERENCES `Reactions` (`Id`) ON DELETE CASCADE
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260918160500_AddEmissionParameters', '8.0.10');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260918163457_AddFirstOrderLossParameters') THEN

    CREATE TABLE `FirstOrderLossParameters` (
        `ReactionId` char(36) COLLATE ascii_general_ci NOT NULL,
        `ScalingFactor` double NULL,
        CONSTRAINT `PK_FirstOrderLossParameters` PRIMARY KEY (`ReactionId`),
        CONSTRAINT `FK_FirstOrderLossParameters_Reactions_ReactionId` FOREIGN KEY (`ReactionId`) REFERENCES `Reactions` (`Id`) ON DELETE CASCADE
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260918163457_AddFirstOrderLossParameters', '8.0.10');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260918171332_AddUserDefinedParameters') THEN

    CREATE TABLE `UserDefinedParameters` (
        `ReactionId` char(36) COLLATE ascii_general_ci NOT NULL,
        `ScalingFactor` double NULL,
        CONSTRAINT `PK_UserDefinedParameters` PRIMARY KEY (`ReactionId`),
        CONSTRAINT `FK_UserDefinedParameters_Reactions_ReactionId` FOREIGN KEY (`ReactionId`) REFERENCES `Reactions` (`Id`) ON DELETE CASCADE
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260918171332_AddUserDefinedParameters', '8.0.10');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260918174248_RemoveReactionAttributeTables') THEN

    DROP TABLE `ReactionNumericalAttributes`;
...
BEGIN
    ...
    DROP TABLE `ReactionStringAttributes`;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260918174248_RemoveReactionAttributeTables', '8.0.10');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260921200544_user-update') THEN

    ALTER TABLE `Users` ADD `OrcidId` longtext CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260921200544_user-update', '8.0.10');
