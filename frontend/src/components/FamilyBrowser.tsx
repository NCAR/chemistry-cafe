import { Button, ButtonGroup, Card, CardActions, CardContent, List, ListItem, Typography } from "@mui/material";
...
const FamilyBrowser: React.FC<FamilyBrowserProps> = ({ families, handleInfoButtonClick, handleEditButtonClick, handleCloneButtonClick }) => {
    return (
        <List>
