      ...
      {isBannerVisible && (
        <div className="banner">
          <p>
            ...
            cookies do not collect personal information about you. When using
            our website, you may encounter embedded content, such as YouTube
            videos and other social media links, that use their own cookies. To
            learn more about third-party cookies on this website, and to set
            your cookie preferences, click here.{" "}
            <a href="https://www.ucar.edu/cookie-other-tracking-technologies-notice">
              Learn more
            </a>
          </p>
